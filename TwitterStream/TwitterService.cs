...
namespace TwitterStream
{
    internal class TwitterService
    {
                ...
                using (var response = await client.GetAsync(url, HttpCompletionOption.ResponseHeadersRead))
                {
                    ...
                    using (var streamReader = new StreamReader(stream))
                    {
                        ...
                        while (line != null)
                        {
                            ...
                            ProcessTweet(tweet, hashTags, topHashTags);
        ...
        private void ProcessTweet(Tweet tweet, Dictionary<string, int> hashTags, List<string> topHashTags)
        {
            if (tweet != null && tweet.Data != null && tweet.Data.Entity != null && tweet.Data.Entity.Hashtags != null)
            {
                foreach (var hashTag in tweet.Data.Entity.Hashtags)
                {
